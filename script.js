...
const phrases = [
  "multi-threaded C++ hot paths",
  "PyTorch inference latency and batching",
  "AWS Lambda, ECS, EKS, S3, and CloudFront flows",
  "timeouts, retries, idempotency, and tracing",
  "HLS/DASH delivery with edge-cache thinking"
];
